/*! TechText from React Bits, Copyright (c) 2026 David Haz.
 * MIT + Commons Clause; see /assets/REACT-BITS-LICENSE.md. */
...
const TechText = ({
  ...
  useEffect(() => {
    ...
    const ensureLayout = (s) => {
      ...
      const x = Math.min(20, width * 0.05) + m.actualBoundingBoxLeft;
